...
function! JavaLocal(...)
    ...
    silent let g:JAVARUN =   "export CLASSPATH=" . $CLASSPATH . ";java  -Xms1024m -Xmx2048m -Xss500m  -XX:+UnlockDiagnosticVMOptions -XX:+LogVMOutput -XX:LogFile=/tmp/jvm.log " . "" . g:Strreplace(expand("%:t"),".java","")
